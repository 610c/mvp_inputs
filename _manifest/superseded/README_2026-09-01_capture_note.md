...
> This is the original capture note from 1 September, kept per the corpus
> convention that superseded material is annotated rather than deleted.
>
> **Its "Not yet captured" list at the bottom is wrong.** Items 3, 5, 6, 7,
> 9-14, 16 and 21-29 are now in. `fetch_all.sh` was never needed — the corpus
> was filled through the browser instead.
>
> **Its "What's here" table is wrong.** It describes 8 folders; there are 15,
> plus `participants/`.
>
> Current documents, in reading order:
>   - `_DATASET_MAP.md`     what is in each folder
>   - `_CORPUS_STATE.md`    roster arithmetic, 2026 vote record, known gaps
>   - `_CORPUS_README.txt`  acquisition manifest by requested item
>   - `_BLOCKED_AND_FUTURE.md`  what could not be retrieved and why
>
> The three findings in section "Three findings that change how you should
> score" below are still correct and still matter.
